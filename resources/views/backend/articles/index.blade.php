                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <form action="{{route('backend.article.destroy', $article)}}" method="post">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#destroyModal-{{$article->id}}"><i class="fas fa-trash fa-fw"></i></button>

                                    <div class="modal" id="destroyModal-{{$article->id}}" tabindex="-1" role="dialog">
